...
void f_pint(stack_t **head, unsigned int ctr);
int execute(char *content, stack_t **head, unsigned int ctr, FILE *file);
void free_stack(stack_t *head);
void f_stack(stack_t **head, unsigned int ctr);
void f_pop(stack_t **head, unsigned int ctr);
void f_swap(stack_t **head, unsigned int ctr);
void f_add(stack_t **head, unsigned int ctr);
void f_nop(stack_t **head, unsigned int ctr);
